...
export declare const BarItemGroup: {
    (props: BarItemGroupProps): JSX.Element;
    displayName: string;
};
...
export declare const DropDownOnClick: {
    ({ renderTrigger, children, dataTestId, offset, placement, open, onToggle, ...props }: DropDownOnClickProps): JSX.Element;
    displayName: string;
};
...
export declare const DropDownOnHover: {
    ({ renderTrigger, children, offset, placement, open, ...props }: DropDownOnHoverProps): JSX.Element;
    displayName: string;
};
...
export declare const MenuItemWithSubmenu: {
    ({ submenuContent, onClick, ...restProps }: MenuItemWithSubmenuProps): JSX.Element;
    displayName: string;
};
...
export declare const Tooltip: {
    ({ children, tooltipText, placement, shortcuts, maxGridUnitWidth, withoutShowDelay, visible, disabled, appendTo, tooltipTextAsHtml, ...props }: TooltipProps): JSX.Element;
    displayName: string;
};
...
export declare interface TreeViewProps extends UITestProps {
    /**
